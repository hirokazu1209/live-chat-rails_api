class LikesController < ApplicationController
  ...
  def create
    ...
    if like.save
      ...
      render json: {message: '保存出来ませんでした', errors: like.errors.messages}, status: :bad_reqest
    end
  end
  ...
  def destroy
    ...
    if like.destroy
      ...
      render json: {message: '削除できませんでした', errors: like.errors.messages}, status: bad_reqest
    end
  end
end
